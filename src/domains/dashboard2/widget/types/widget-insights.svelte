...
<div class="flex flex-col h-full justify-between">
  ...
  {:else if insight}
    <div class="px-2 h-full flex flex-col">
      <div class="insight-container px-3 py-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition border border-primary-500 rounded mb-2" onclick={openFullInsightModal}>
